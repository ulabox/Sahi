...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1303307784);
user_pref("app.update.lastUpdateTime.background-update-timer", 1182011519);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1303307596);
user_pref("app.update.lastUpdateTime.microsummary-generator-update-timer", 1302770014);
user_pref("app.update.lastUpdateTime.places-maintenance-timer", 1303309767);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1303312393);
...
user_pref("idle.lastDailyNotification", 1303292283);
...
user_pref("urlclassifier.keyupdatetime.https://sb-ssl.google.com/safebrowsing/newkey", 1305912465);
